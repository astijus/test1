...
class OthersControllerTest < ActionController::TestCase
  ...
  test "should create other" do
    assert_difference('Other.count') do
      post :create, other: { age: @other.age, answer: @other.answer, gender: @other.gender, profession: @other.profession }
    end
  ...
  test "should update other" do
    patch :update, id: @other, other: { age: @other.age, answer: @other.answer, gender: @other.gender, profession: @other.profession }
    assert_redirected_to other_path(assigns(:other))
  end
